(function ($) {
	...
	api = {
		register: function (context) {
			...
			$('#' + context.wrapperId + ' div.open-search-detail div.os-content-list-footer a').live('click', function (e, data) {
			...
			$('#' + context.wrapperId + ' div.open-search-detail ul.search-results li.os-result').live('mouseenter', function (e, data) {
				if (!$(this).hasClass("selected")) {
					$(this).addClass("selected");
				}
			}).live('mouseleave', function (e, data) {
				if ($(this).hasClass("selected")) {
	...
	$.telligent.evolution.widgets.externalSearchDetailResults = api;
} (jQuery));