...
;(function ($) {
    $.contextMenu = {
        ...
        create: function (menu, opts) {
            ...
            $('body').bind('click', function () { cmenu.hide(); }); // If clicked somewhere else in the document, hide this menu
    ...
    $.fn.contextMenu = function (menu, options) {
        ...
        return this.each(function () {
            if (options.rightClick) { binder = 'contextmenu'; }
            $(this).bind(binder, function (e) { cmenu.show(this, e); return false; });
        });
    };
