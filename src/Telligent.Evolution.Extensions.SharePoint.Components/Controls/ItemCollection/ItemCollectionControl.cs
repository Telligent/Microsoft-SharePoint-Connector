...
[assembly: WebResource("Telligent.Evolution.Extensions.SharePoint.Components.Controls.ItemCollection.ItemCollection.js", "text/javascript")]
    ...
    public abstract class ItemCollectionControl : Control
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            CSControlUtility.Instance().RegisterClientScriptResource(this, typeof(ItemCollectionControl),
                "Telligent.Evolution.Extensions.SharePoint.Components.Controls.ItemCollection.ItemCollection.js");
        }
        #endregion
        ...
        private Dictionary<ItemCollectionAttribute, PropertyInfo> LoadPropertiesAndTitles(Type itemType)
        {
            ...
            foreach (PropertyInfo property in allProperties)
            {
                ...
                if (attr != null && attr.Length > 0)
                {
                    ...
                    if (title != null && !properties.ContainsKey(title))
