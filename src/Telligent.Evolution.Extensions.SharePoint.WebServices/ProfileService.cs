...
{
    public class ProfileService : UserProfileService.UserProfileService
    {
        private readonly Authentication authentication;
        private readonly WindowsImpersonationContext impersonate;
        private readonly string siteUrl;

        public ProfileService(string siteUrl, Authentication authentication)
        {
            Url = siteUrl.TrimEnd('/') + "/_vti_bin/UserProfileService.asmx";
