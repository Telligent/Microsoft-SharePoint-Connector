...
{
    public class VersionService : VersionsService.Versions
    {
        private readonly Authentication authentication;
        private readonly WindowsImpersonationContext impersonate;
        private readonly string siteUrl;

        public VersionService(string siteUrl, Authentication authentication)
        {
            Url = siteUrl.TrimEnd('/') + "/_vti_bin/Versions.asmx";
